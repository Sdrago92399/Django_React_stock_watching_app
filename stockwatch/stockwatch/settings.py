...
SECRET_KEY = 'django-insecure-#s83qt&m+%9i7n-&2em#14($@be)uv7p-6ul@0@ilc+u%brl@-'
...
ASGI_APPLICATION = 'stockwatch.asgi.application'
...
DATABASES = {
    'default': {
        ...
        'CLIENT': {
            'host': os.environ.get('MONGODB_URI', env('MONGODB_URI')),
        }
    }
}
...
# Stock API settings
STOCK_API_KEY = os.environ.get('STOCK_API_KEY', env('STOCK_API_KEY'))
